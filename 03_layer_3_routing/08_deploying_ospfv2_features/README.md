# Lab Guide: Deploying OSPFv2 Features
...
The second part of the lab comprises of encrypted authentication between ospf neighbors using configurations with a key-chain
